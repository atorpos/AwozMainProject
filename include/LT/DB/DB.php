...
abstract class DB {
    ...
    public static function conn($name = 'db.default') {
		...
		if (array_key_exists('password_level', $params) && strlen($params['password_level']) > 0) {
			$params['password'] = \PA\Secure\Password::decrypt($params['password'],$params['password_level']);
		}
